...
norm_chunk <- function(chunk)
{
 ...
 str <- chunk@files[1]
 name <- gsub('[C:/Users/cmarmy/Documents/STDL/Beeches/FHI/las/.las]','',str)
 mySHP<- st_read(paste0('C:/Users/cmarmy/Documents/STDL/Beeches/FHI/extent/',name,'.shp'))
 myExt <-extent(mySHP)
 ...
 agl <- rasterize_canopy(filter_poi(nlas, Z >= 0.5 & Z <=10 ), res=0.5, pitfree(thresholds = c(0,5,10), max_edge = c(0, 1.5), subcircle = 0.15)) # adjust max_edge for smooting 
 ...
 # mask_<- pixel_metrics(nlas, ~mean(Z), 1)
...
ctg <- readLAScatalog("C:/Users/cmarmy/Documents/STDL/Beeches/FHI/las/", select = "xyzcrn")
opt_output_files(ctg) <- paste0("C:/Users/cmarmy/Documents/STDL/Beeches/FHI/", "/{*}")
...
# files <- list.files(path="C:/Users/cmarmy/Documents/STDL/Beeches/FHI/", pattern="*_params.tif", full.names=TRUE, recursive=FALSE)
# 
# r0 <- rast(files[1])
# for (f in files){
#   r <- rast(f)
...
# }
# 
# writeRaster(r0, "C:/Users/cmarmy/Documents/STDL/Beeches/FHI/mosaic.tif", overwrite=TRUE)
# 
# 
# ## Mosaïc of masks 
# files <- list.files(path="C:/Users/cmarmy/Documents/STDL/Beeches/FHI/", pattern="*_mask.tif", full.names=TRUE, recursive=FALSE)
# 
# r0 <- rast(files[1])
# for (f in files){
#   r <- rast(f)
...
# }
# 
# writeRaster(r0, "C:/Users/cmarmy/Documents/STDL/Beeches/FHI/mosaic_mask.tif", overwrite=TRUE)

## Mosaïc of masks 
files <- list.files(path="C:/Users/cmarmy/Documents/STDL/Beeches/FHI/", pattern="*_agl.tif", full.names=TRUE, recursive=FALSE)
...
writeRaster(r0, "C:/Users/cmarmy/Documents/STDL/Beeches/FHI/mosaic_agl.tif", overwrite=TRUE)