...
#> - mosaic_seg_params.shp : polygones of the segmentation with structural parameters.
...
red_b <- image_params[image_params$band=="bleu",][,-c(1,8,9)]
...
green_b <- image_params[image_params$band=="bleu",][,-c(1,8,9)]
...
pca_ir <- read.csv(paste0(SIM_STATS,"PCA_beeches_procheIR_band_values.csv")) 
pca_ir <- pca_ir[,-c(6)]
